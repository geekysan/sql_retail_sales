...
2. **Write an SQL query to retrieve all transactions where the category is 'Clothing' and the quantity sold is >= 4 in the month of Nov 2022**:
```sql
SELECT * FROM retail_sales
...
4. **Write an SQL query to find the avg age of the customers who purchased items from the 'Beauty' category**:
```sql
